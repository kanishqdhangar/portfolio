              ...
              <Card className="p-8 bg-gray-900 border-primary/20">
                ...
                <div className="flex flex-wrap gap-3">
                  <Button
                    ...
                    asChild
                  >
                    <a href="https://drive.google.com/drive/folders/19E2EzDrnKLfWJdWaV8wPFzPF7Or6bwEX?usp=drive_link" target="_blank" rel="noopener noreferrer" className="text-white">
                      View Resume
                    </a>
                  </Button>
                  <Button
